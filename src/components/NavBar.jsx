       ...
       <div className='container flex justify-between'>
        ...
        <div className='hidden md:block w-1/2'>
            ...
            {NavBarData.map((item) => {
                ...
                <li 
                key={item.id}
                className={`py-2 px-3 text-lg cursor-pointer text-slate-900 hover:bg-rose-500 hover:text-white hover:rounded-md ${activeLink === item.link ? 'font-bold' : ''}`}
                onClick={() => {
        ...
        {activeItem && (
            ...
            <FaAngleLeft className='w-2 h-4 text-slate-900' onClick={() => {setOpen(!open)}}/>
